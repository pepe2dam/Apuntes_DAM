...
+ Array: Es una estructura interna que permite guardar datos del mismo tipo en una única variable. 
Para hacer referencia a esos datos se utilizan uno o varios índices según la dimensión. .Net acepta 
...
La dimensión es el número de elementos que tenga la listaValores, si se quieren dar más posiciones
...
de cocina de tal manera que deberá aparecer cual es la puntuación más alta y a que numero de 
participante pertenece, la puntuación más baja y a que numero de participante pertenece y la 
nota media.
...
tipos de datos (numéricos y de cadena), esto es imposible en una matriz, por lo que es aconsejable 
utilizar el concepto de Array Paralelo que consiste en utilizar varios vectores, gestionados a la 
par, es decir, gestionando el mismo índice de todos los Arrays.
